    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto flex max-w-7xl flex-col items-center px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center lg:mx-0 ">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">{faq.subTitle}</p>
        </div>
        <dl className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 text-left text-base leading-7 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
